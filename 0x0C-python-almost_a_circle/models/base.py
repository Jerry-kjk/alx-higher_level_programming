...
class Base:
    """
    Private class attribute to track the number of objects created.
    """
    ...
    def load_from_file(cls):
        """
        Return a list of class instances instantiated from
        a file of JSON strings.
        Reads from `<cls.__name__>.json` file and creates instances
        based on the data.
        Returns:
