...
class Rectangle(Base):
   ...
   def height(self, value):
    ...
    def display(self):
        """
        Display the Rectangle by printing it to stdout with
        the character '#'
        """
    ...
    def update(self, *args, **kwargs):
        """
        Update the attributes of the Rectangle based on the
        provided arguments.

        Args:
            *args (ints): The arguments representing the attribute
            values in the order:
